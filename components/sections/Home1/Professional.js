                        ...
                        <div className="col-xl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="professional__item">
                                ...
                                <div className="content">
                                    ...
                                    <p className="text">Offering one-day delivery of filter bags & parts!
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-xxl-3 wow fadeInLeft" data-wow-delay="400ms"
                            ...
                            <div className="professional__item-last">
                                ...
                                <div className="content">
                                    ...
                                    <p className="text">Our friendly staff are available to support you 24/7
                                    </p>
                                    <a onClick={() => setOpen(true)} className="item-btn video-popup">Our friendly staff are available to support you 24/7
                                        <svg width="8"

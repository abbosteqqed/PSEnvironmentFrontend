                ...
                <div className="container">
                    <div className="header__main">
                        {/* <Link href="/" className="logo logo-light">
                            <img src="assets/images/logo/PSlogo.png" alt="logo" />
                        </Link> */}
            ...
            <div className={`sidebar-area offcanvas offcanvas-end ${sidebarToggle ? "show" : ""}`} id="menubar">
                ...
                <div className="offcanvas-body sidebar__body">
                    ...
                    <div className="d-none d-lg-block">
                        ...
                        <p className="sidebar__text">PS Environmental Services Inc. specializes in air pollution control, offering expert maintenance and
                                dust collection solutions for industrial facilities across the U.S.</p>
                    </div>

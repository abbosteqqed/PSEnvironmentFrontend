        ...
        <>
                    ...
                    <div className="header-top__wrp">
                        <ul className="header-top__links">
                            <li>
                                ...
                                <Link href="/">West Coast:318 Avenue, Unit 454
                                    Redondo Beach, CA | East Coast:878 Donegal Drive Follansbee, WV.26037
                                    90277</Link>
                            </li>
                            <li>
                                <i className="fa-light fa-envelope-open-text" />
                                <Link href="/">joe@psenvironmental.com</Link>
                            </li>
                        </ul>
            ...
            <header className={`header-area header-blur ${scroll ? "menu-fixed" : ""}`}>
                {/* <div className="container">
                    <div className="header__main">
                        <Link href="/" className="logo logo-main"><img src="assets/images/logo/logo4.png" alt="logo" /></Link>
                         <Link href="/" className="logo" style={{marginRight: '900px', width:"230px",}}><img src="assets/images/logo/PSlogo1.png" alt="logo" /></Link>
                         <div className="company-name">
                            <span className="line1">PS Environmental</span>
                            <span className="line2">Services Inc.</span>
                            </div>

                         <Link href="/" className="logo logo-light"><img src="assets/images/logo/PSlogo.png" alt="logo" /></Link> 
            ...
            <div className={`sidebar-area offcanvas offcanvas-end ${sidebarToggle ? "show" : ""}`} id="menubar">
                <div className="offcanvas-header">
                    {/* <Link href="/" className="logo" style={{display: 'block', width: '20%', height: '18%'}}><img src="assets/images/logo/logo4.png" alt="logo" /></Link> */}
                    <div className="logo-and-name">
                     <Link href="/" className="logo" style={{display: 'block', width: '20%', height: '18%'}}><img src="assets/images/logo/logo4.png" alt="logo" /></Link>
                    <div className="company-name">
                        <span className="line1">PS ENVIRONMENTAL</span>
                ...
                <div className="offcanvas-body sidebar__body">
                    ...
                    <div className="sidebar__contact-info mt-30">
                        ...
                        <ul>
                            ...
                            <li><i className="fa-solid fa-paper-plane" /><Link href="/">joe@psenvironmental.com</Link></li>
                        </ul>
                    </div>

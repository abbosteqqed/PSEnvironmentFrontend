                ...
                <div className="offer__wrp">
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-8">
                            ...
                            <h2 id="filter-bag-changeovers" className="mt-4">Filter Bag Changeovers</h2>
								<p className="fs-4">Professional removal and installation of filter bags to minimize downtime and prevent contamination.</p>
								<br />
								<p className="fs-4">• Removal of spent filters and cages</p>
								<p className="fs-4">• Installation of new filter bags with correct fit and sealing</p>
								<p className="fs-4">• Gasket and seal inspection/replacement</p>
								<p className="fs-4">• Dust handling and waste disposal coordination</p>
								<p className="fs-4">• Initial startup testing post-change</p>

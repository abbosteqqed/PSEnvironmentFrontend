                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content position-relative overflow-hidden px-3">
								...
								<h2 id="preventive-maintenance" className="mt-4">Preventive Maintenance Plans</h2>
								<p className="fs-4">Planned service routines designed to extend equipment life, ensure compliance, and minimize costly unplanned downtime.</p>
								<br />
								<p className="fs-4">• Filter integrity checks</p>
								<p className="fs-4">• Pulse valve and solenoid inspections</p>
								<p className="fs-4">• Leak testing and gasket integrity checks</p>
								<p className="fs-4">• Cleaning of hoppers and ductwork</p>
								<p className="fs-4">• Fan alignment, lubrication, and motor inspection</p>
								<p className="fs-4">• Scheduled filter change forecasts</p>

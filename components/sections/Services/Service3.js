                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content position-relative overflow-hidden px-3">
                              ...
                              <h2 id="master-service-contracts" className="mt-4">Master Service Contracts</h2>
								<p className="fs-4">Long-term, bundled service agreements tailored for clients with multiple sites or recurring needs, offering priority response and discounted rates.</p>
								<br />
								<p className="fs-4">• Scheduled preventive maintenance</p>
								<p className="fs-4">• Annual or semi-annual system audits</p>
								<p className="fs-4">• Emergency response priority</p>
								<p className="fs-4">• Customized reporting and performance tracking</p>
								<p className="fs-4">• Spare parts inventory management</p>

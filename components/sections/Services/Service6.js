                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content position-relative overflow-hidden px-3">
                             ...
                             <h2 id="inspections-reports" className="mt-4">Inspections & Reports</h2>
								<p className="fs-4">Detailed evaluations supported by visual inspections, performance data, and expert recommendations for corrective action.</p>
								<br />
								<p className="fs-4">• Visual and operational inspection of all components</p>
								<p className="fs-4">• Photo documentation and summary of findings</p>
								<p className="fs-4">• Measured system metrics (e.g., pressure drops, airflow, emissions)</p>
								<p className="fs-4">• Compliance gap identification</p>
								<p className="fs-4">• Digital report delivery with maintenance and CAPEX recommendations</p>

                    ...
                    <div className="choose-one__wrp">
                        ...
                        <div className="tab-content mt-50">
                            {activeIndex === 1 && (
                                <div className="tab-pane active">
                                    <div className="choose-one__content">
                                        <p className="mb-50">
                                            In an industrial landscape driven by efficiency, safety, and compliance, reliable air pollution control is not optional—it’s essential. Yet, not every operation knows the best path forward. That’s where we come in.
                                        </p>
                                        <div className="item">
                                            <div className="icon">
                                            ...
                                            <p>
                                                We believe people are at the core of every successful solution. That’s why PS Environmental Services focuses on empowering industries with expert dust collection and filtration systems—ensuring clean air, smooth operations, and sustainable growth.
                                            </p>
                                        </div>
                                        <div className="line" />
                                        <div className="item">
                                            ...
                                            <div>
                                                <p>
                                                   With decades of hands-on experience, we’re committed to helping you operate smarter, safer, and cleaner. Our goal is to be more than a service provider—we’re your long-term partner in system performance and compliance.
                                                </p>
                                                <ul className="mt-25">
                                                    <li>
                            ...
                            {activeIndex === 2 && (
                                <div className="tab-pane active">
                                    <div className="choose-twelve__content">
                                        <p>
                                            Combining decades of hands-on experience with innovative solutions, we deliver exceptional value by ensuring efficient, compliant, and reliable air pollution control systems...
                                        </p>
                                        <div className="list mt-30 mb-40">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    Tailored Technical Consultations
                                                </li>
                                            </ul>
                                            <ul>
                                                <li>
                            ...
                            {activeIndex === 3 && (
                                <div className="tab-pane active">
                                    <p>
                                    In today’s industrial environment, ensuring efficient and compliant air pollution control requires a clear, expert-driven process.
                                    </p>
                                    ...
                                    {[
                                        ...
                                        <div className="content">
                                            ...
                                            <p>
                                            {i === 0 &&
                                                "We engage with clients to understand their dust collection system needs, challenges, and operational goals."}
                                            {i === 1 &&
                                                "Our experts conduct thorough system assessments, including airflow analysis, diagnostics, and compliance checks."}
                                            {i === 2 &&
                                                "We develop tailored solutions—maintenance, repairs, or upgrades—and provide ongoing training and emergency response."}
                                            </p>
                                        </div>
                                        </div>
                                    ))}
                                    </div>
                                    {/* <Link href="/page-about" className="btn-one mt-50" data-splitting data-text="Learn More">
                                    Learn More
                                    </Link> */}
                                </div>
                                )}

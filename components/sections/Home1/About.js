                    ...
                    <div className="col-lg-4">
                        <div className="about__item about__content">
                            <h4 className="color-light wow splt-txt" data-splitting>
                               PS Environmental Services Inc. specializes in air pollution control, offering expert maintenance and
                                dust collection solutions for industrial facilities across the U.S.
                            </h4>
                            <ul>
                                {[
                                    "Dust collection system design corrections and airflow optimization.",
                                    "Routine inspections, troubleshooting, and repairs.",
                                    "Filter bag and parts supply with fabric selection expertise",
                                    "Safety-certified service in hazardous environments"
                                ].map((item, index) => (
                                    <li key={index}>
                    ...
                    <div className="col-lg-4">
                        <div className="about__item about__testimonial">
                            <div>
                                ...
                                <p>Their client-focused approach optimizes dust collection systems, enhancing efficiency and minimizing downtime. From the beginning, they invest time to understand your operational needs and deliver the best solution.</p>
                            </div>
